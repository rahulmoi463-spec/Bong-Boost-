...
// অর্ডার স্ট্যাটাস আপডেট করার লজিক
if (isset($_POST['update_status'])) {
    $order_id = (int)$_POST['order_id'];
    $status = $_POST['status'];
    pg_query_params($dbconn, "UPDATE orders SET status = $1 WHERE id = $2", array($status, $order_id));
                ...
                <tbody>
                    <?php if($orders_res && pg_num_rows($orders_res) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- শুধুমাত্র এই নির্দিষ্ট অর্ডারটি মুছে ফেলার বাটন -->
