...
// ফ্রি ক্লেম রেকর্ড ডিলিট করার লজিক
...
// সকল কাস্টমারের জমা দেওয়া ফ্রি ভিউজের তথ্য নিয়ে আসা
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo htmlspecialchars($c['link']); ?>" target="_blank" class="btn btn-sm btn-outline-primary">
                                    <i class="fa-solid fa-arrow-up-right-from-square me-1"></i> Open Reel
                                </a>
                            </td>
                            <td><code><?php echo htmlspecialchars($c['ip_address']); ?></code></td>
                            <td><?php echo htmlspecialchars($c['last_claimed_at']); ?></td>
                            <td>
                                <a href="free_claims.php?delete_claim_id=<?php echo $c['id']; ?>" onclick="return confirm('Are you sure you want to delete this claim record?')" class="btn btn-sm btn-danger">
