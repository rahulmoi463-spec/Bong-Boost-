                ...
                <table class="table table-bordered table-striped align-middle">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th>Username</th>
                            <th>Mobile</th>
                            <th>Balance & Special Discount (%)</th>
                            <th>Status</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if($users_res && pg_num_rows($users_res) > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" class="d-flex align-items-center" style="max-width: 280px;">
                                        <input type="hidden" name="user_id" value="<?php echo $u['id']; ?>">
                                        <div class="input-group input-group-sm me-1">
                                            <span class="input-group-text">₹</span>
                                            <!-- max সীমা ১০০,০০০,০০০ (১০ কোটি) সেট করা হয়েছে -->
                                            <input type="number" step="0.01" min="0" max="100000000" name="balance" value="<?php echo $u['balance']; ?>" class="form-control" title="User Balance">
                                        </div>
                                        <div class="input-group input-group-sm me-1">
