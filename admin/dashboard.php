...
if (isset($_POST['update_notice'])) {
    ...
    // Check if notice with ID 1 exists
...
// User Actions (Balance & Discount Update, Ban, Delete)
if (isset($_POST['update_user_details'])) {
    $u_id = (int)$_POST['user_id'];
    $bal = (float)$_POST['balance'];
    $disc = (int)$_POST['discount_percent'];
    
    pg_query_params($dbconn, "UPDATE users SET balance = $1, discount_percent = $2 WHERE id = $3", array($bal, $disc, $u_id));
    $msg = "User balance and discount updated successfully!";
}
                                ...
                                <td>
                                    <form method="POST" class="d-flex align-items-center" style="max-width: 280px;">
                                        ...
                                        <div class="input-group input-group-sm me-1">
                                            ...
                                            <input type="number" step="0.01" name="balance" value="<?php echo $u['balance']; ?>" class="form-control" title="User Balance">
                                        </div>
                                        <div class="input-group input-group-sm me-1">
