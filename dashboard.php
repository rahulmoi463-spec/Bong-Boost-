  ...
  <div class="container d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <button class="menu-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebarMenu" aria-controls="sidebarMenu">
        <i class="fa-solid fa-bars me-1"></i> <span class="d-none d-md-inline style-sm" style="font-size: 14px;">Menu</span>
      </button>
    </div>
  </div>
</nav>
...
<!-- Main Container Centered View -->
<div class="container pb-5 min-vh-100 d-flex flex-column justify-content-center align-items-center">

    <!-- Create New Order Card (Centered) -->
    <div class="row justify-content-center w-100">
        <div class="col-lg-7 col-md-9 col-sm-12">
            <div class="glass-card p-4 p-md-5">
                <div class="text-center mb-4">
                    <h3 class="fw-extrabold text-dark mb-1"><i class="fa-solid fa-cart-plus text-primary me-2"></i>New Order</h3>
                    <p class="text-muted small">Select your required category and service to place order instantly</p>
                </div>
