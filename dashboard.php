...
<head>
    ...
    <style>
        ...
        .navbar { background: rgba(15, 23, 42, 0.85) !important; backdrop-filter: blur(12px); border-bottom: 1px solid rgba(255, 255, 255, 0.1); }
        .glass-card { background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(20px); border: 1px solid rgba(255, 255, 255, 0.6); border-radius: 20px; box-shadow: 0 20px 40px rgba(0, 0, 0, 0.25); }
        .compact-notice-bar { background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 16px; padding: 16px 22px; color: #ffffff; box-shadow: 0 8px 20px rgba(79, 70, 229, 0.3); margin-bottom: 24px; }
        .form-label { font-weight: 700; color: #0f172a; font-size: 14px; margin-bottom: 6px; }
        .form-control, .form-select { background-color: #f8fafc !important; border: 2px solid #cbd5e1 !important; color: #0f172a !important; font-weight: 600 !important; border-radius: 12px !important; padding: 12px 16px !important; font-size: 15px !important; }
        .form-control:focus, .form-select:focus { background-color: #ffffff !important; border-color: #6366f1 !important; box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.2) !important; }
        .btn-3d-primary { background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: #fff; border: none; border-radius: 12px; padding: 14px; font-weight: 700; box-shadow: 0 6px 20px rgba(99, 102, 241, 0.4); }
        .btn-whatsapp { background: #25D366; color: #fff; font-weight: 700; border-radius: 10px; }
        ...
        .desc-box { background: #f1f5f9; border: 1px solid #cbd5e1; border-radius: 12px; padding: 16px; white-space: pre-line; font-size: 14px; color: #334155; max-height: 250px; overflow-y: auto; font-weight: 500; }
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="glass-card p-4 p-md-5">
                <h4 class="fw-bold text-center mb-4 text-dark"><i class="fa-solid fa-cart-plus text-primary me-2"></i>Select Service</h4>
