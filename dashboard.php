...
<!-- Main Container Clean View -->
<div class="container py-2 pb-5">

    <!-- Top Stats Bar for Professional Look -->
    <div class="row justify-content-center mb-4 g-3 col-lg-7 mx-auto">
        <div class="col-6 col-sm-6">
            <div class="stat-card text-center">
                <div class="text-muted small fw-bold mb-1"><i class="fa-solid fa-wallet text-success me-1"></i> Available Balance</div>
                <div class="fs-4 fw-extrabold text-white">₹<?php echo number_format($user['balance'], 2); ?></div>
            </div>
        </div>
        <div class="col-6 col-sm-6">
            <div class="stat-card text-center">
                <div class="text-muted small fw-bold mb-1"><i class="fa-solid fa-shield-halved text-info me-1"></i> Account Status</div>
        ...
        <div class="col-lg-7 col-md-9 col-sm-12">
            <div class="glass-card">
                <div class="text-center mb-4">
                    <span class="badge bg-primary bg-opacity-25 text-primary border border-primary border-opacity-25 px-3 py-2 rounded-pill mb-2 fw-bold" style="font-size: 12px;">
                ...
                <form method="POST">
                    ...
                    <div class="mb-4">
                        <label class="form-label text-info"><i class="fa-solid fa-magnifying-glass me-1"></i> Quick Search Services</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-layer-group me-1 text-secondary"></i> Category</label>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-list-check me-1 text-secondary"></i> Service</label>
                    ...
                    <div id="descContainer" class="mb-3 d-none">
                        <label class="form-label text-info"><i class="fa-solid fa-circle-info me-1"></i> Service Details & Description</label>
                        <div id="serviceDescText" class="desc-box"></div>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-link me-1 text-secondary"></i> Target Link (URL)</label>
                        <input type="url" name="link" class="form-control" placeholder="https://instagram.com/username..." required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label"><i class="fa-solid fa-arrow-up-9-1 me-1 text-secondary"></i> Quantity</label>
                        <input type="number" name="quantity" id="quantityInput" class="form-control" placeholder="e.g. 1000" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-bold text-white"><i class="fa-solid fa-receipt me-1 text-secondary"></i> Total Charge</label>
...
<div class="modal fade" id="noticeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content text-white" style="background: rgba(15, 23, 42, 0.95); backdrop-filter: blur(25px); border-radius: 24px; border: 1px solid var(--glass-border); box-shadow: 0 25px 50px rgba(0,0,0,0.7);">
            ...
            <div class="modal-body p-4" style="font-size: 15px; line-height: 1.7; color: #cbd5e1;">
